...
:command:`oome_monitor`
    This plugin originally designed to restart configured tomcat processes
    based on the ".oome" file generated by java process when it hits out of
    memory condition.
